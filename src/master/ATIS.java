 ...
 * @author Admin
 */
public class ATIS extends javax.swing.JFrame {
...
private String hashPassword(String password) {
    ...
    private void initComponents() {
        ...
        jmMstKategori.setText("Master Kategori");
        ...
        MstBarang.setText("Master Barang");
        ...
        jmMstCus.setText("Master Pelanggan");
        jMenu1.add(jmMstCus);

        jmMstSupp.setText("Master Supplier");
        ...
        jLabel5.setText("APOTEK RH FARMA");

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/apotek.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 1108, Short.MAX_VALUE)
...
//    Connection conn = Koneksi.getConnection();
    ...
    try {
        ...
        if (rs.next()) {
            ...
            // Arahkan ke form selanjutnya jika perlu
        } else {
    ...
    private void MstBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MstBarangActionPerformed
        // TODO add your handling code here:
            frmMstBarang fb = new frmMstBarang();
            fb.setVisible(true);
...
//         txtPassword.setSelected(false);
    ...
    private void jMenuPOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuPOActionPerformed
        // TODO add your handling code here:
        uTransPO utranspo = new uTransPO();
        utranspo.setVisible(true);
    ...
    private void jmMstKategoriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmMstKategoriActionPerformed
        // TODO add your handling code here:
        frmMstKategori mstKategori = new frmMstKategori();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ATIS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
