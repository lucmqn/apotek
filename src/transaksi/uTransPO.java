 ...
 * @author Admin
 */
public class uTransPO extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(uTransPO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
